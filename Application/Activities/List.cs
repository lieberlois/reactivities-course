...
namespace Application.Activities
{
    public class List
    {
        ...
        public class Query : IRequest<ActivitiesWrapper>
        {
        ...
        public class Handler : IRequestHandler<Query, ActivitiesWrapper>
        {
            ...
            public async Task<ActivitiesWrapper> Handle(Query request, CancellationToken cancellationToken)
            {
